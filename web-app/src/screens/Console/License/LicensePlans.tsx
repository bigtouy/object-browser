...
const LicensesInformation = styled.div(({ theme }) => ({
  ...
  "& > div": {
    ...
    "&.enterprise": {
      borderRight: t("#a0a0a0 2px solid"),
      borderLeft: t("#a0a0a0 2px solid"),
      "&.first": {
        borderTop: t("#a0a0a0 2px solid"),
        borderTopLeftRadius: 12,
        borderTopRightRadius: 12
      },
      "&.last": {
        paddingBottom: 30,
        borderBottom: t("#a0a0a0 2px solid"),
        borderBottomLeftRadius: 12,
        borderBottomRightRadius: 12
      }
    },
      ...
      <LicensesInformation>
        ...
        {[null, ...LICENSE_PLANS_INFORMATION].map((element, index) => {
          return (
            <Box
              className={`last ${
              index === 1 ? "openSource" : index === 2 ? "enterprise" : ""} noBorderBottom`
              }
              sx={{
                display: "flex",
                justifyContent: "center"
